    ...
    <div>
      <main
       ...
       <div className='bg-black'>
        ...
        {/* Redes sociales */}
        <div className="mt-3 flex justify-center gap-5 bg-black">
          <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
            <img src={facebookIcon} alt="Facebook" className="w-13 h-16 hover:scale-110 transition-transform" />
          </a>
          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
            <img src={instagramIcon} alt="Instagram" className="w-13 h-16 hover:scale-110 transition-transform" />
          </a>
          <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
            <img src={tiktokIcon} alt="Twitter" className="w-13 h-16 hover:scale-110 transition-transform" />
          </a>
        </div>
        ...
        >
            ...
            src={location}
            alt="location"
            className="w-12 h-14 mb-2 hover:scale-110 transition-transform"
            />
