          ...
          <table className="w-full text-center border-collapse border border-black ">
            <thead className="bg-black text-white font-mono  ">
              <tr>
                {[
                  ...
                  'Marca', 'Modelo', 'Placa', 'Fecha', 'Fecha Salida', 
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-black px-4 py-2">01/11/2023</td>
                <td className="border border-black px-4 py-2">05/11/2023</td>
                <td className="border border-black px-4 py-2">Cambio de aceite</td>
                <td className="border border-black px-4 py-2">Carlos Pérez</td>
                <td className="border border-black px-4 py-2">Completado</td>
