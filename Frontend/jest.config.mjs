...
const config = {
  ...
  // cacheDirectory: "C:\\Users\\pinzo\\AppData\\Local\\Temp\\jest",
  ...
  transform: {
    "^.+\\.(js|jsx|mjs)$": "babel-jest", // Transforma los archivos JS, JSX y MJS
  },
  ...
  setupFilesAfterEnv: ["<rootDir>/jest.setup.js"], // Archivo de configuración global
